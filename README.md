...
&emsp;&emsp;<font bgcolor="#660000">注：本调度平台所使用到的所有安装程序和文件均可在[这里]()找到，密码为。</font><br />

## 1.2 安装

&emsp;&emsp;打开Eclipse，依次选择File->Import->Git->Projects from Git->Clone URI，Next之后填写Github远程仓库地址：[https://github.com/hanbaoan123/JobShopScheduler.git](https://github.com/hanbaoan123/JobShopScheduler.git)，
