...
/**
 * SPTxTWKR规则，选择工序加工时间与剩余加工时间乘积最小的工件。
 * 
 * @author hba
 *
 */
public class OperationSPTTWKRMulti extends OperationRule implements Comparator<Operation>, Serializable {
	public OperationSPTTWKRMulti() {
		super(15, "SPTTWKRMulti");
