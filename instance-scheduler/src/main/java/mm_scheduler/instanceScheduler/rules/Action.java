...
public class Action {
	...
	public void setActionName() {
		if (this.actionId == Action.PART_ACTION_SYSTEM_RULE) {
			this.actionName = "系统规则";
		} else if (this.actionId == Action.PART_ACTION_SPT) {
			this.actionName = "SPT规则";
		} else if (this.actionId == Action.PART_ACTION_LPT) {
			this.actionName = "LPT规则";
		} else if (this.actionId == Action.PART_ACTION_MINSEQ) {
			this.actionName = "MINSEQ规则";
		} else if (this.actionId == Action.PART_ACTION_SRPT) {
			this.actionName = "SRPT规则";
		} else if (this.actionId == Action.PART_ACTION_LRPT) {
			this.actionName = "LRPT规则";
		} else if (this.actionId == Action.PART_ACTION_EDD) {
			this.actionName = "EDD规则";
		} else if (this.actionId == Action.PART_ACTION_OPNDD) {
			this.actionName = "OPNDD规则";
		} else if (this.actionId == Action.PART_ACTION_FOPNR) {
			this.actionName = "FOPNR规则";
		} else {
			this.actionName = "";
		}
	}
