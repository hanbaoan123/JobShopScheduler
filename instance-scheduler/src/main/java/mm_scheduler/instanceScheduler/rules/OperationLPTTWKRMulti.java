...
/**
 * LPTxTWKR规则，选择工序加工时间与剩余加工时间乘积最大的工件。
 * 
 * @author hba
 *
 */
public class OperationLPTTWKRMulti extends OperationRule implements Comparator<Operation>, Serializable {
	public OperationLPTTWKRMulti() {
		super(16, "LPTTWKRMulti");
