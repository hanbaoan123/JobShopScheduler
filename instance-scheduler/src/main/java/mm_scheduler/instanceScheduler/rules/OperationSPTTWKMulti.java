...
/**
 * SPTxTWK规则，选择工序加工时间与总加工时间乘积最小的工件
 * 
 * @author hba
 *
 */
public class OperationSPTTWKMulti extends OperationRule implements Comparator<Operation>, Serializable {
	public OperationSPTTWKMulti() {
		super(13, "SPTTWKMulti");
