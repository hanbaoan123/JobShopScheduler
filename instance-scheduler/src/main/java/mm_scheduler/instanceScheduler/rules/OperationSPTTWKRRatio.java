 ...
 *
 */
public class OperationSPTTWKRRatio extends OperationRule implements Comparator<Operation>, Serializable {
	public OperationSPTTWKRRatio() {
		super(11, "SPTTWKRRatio");
